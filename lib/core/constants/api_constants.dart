...
class ApiConstants {
  ...
  static const String forgotPassword =
      '/auth/forgot-password'; // Endpoint quên mật khẩu
  static const String changePassword =
      '/auth/change-password'; // Endpoint đổi mật khẩu
  static const String refreshToken =
      '/auth/refresh-token'; // Endpoint làm mới token

  // Các giá trị timeout cho kết nối API
  static const int connectionTimeout =
      30000; // Thời gian chờ kết nối tối đa: 30 giây
  static const int receiveTimeout =
      30000; // Thời gian chờ nhận phản hồi tối đa: 30 giây
}
